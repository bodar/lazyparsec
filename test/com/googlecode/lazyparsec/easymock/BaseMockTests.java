 ...
 *****************************************************************************/
package com.googlecode.lazyparsec.easymock;
 ...
 * @author Ben Yu
 */
public abstract class BaseMockTests extends TestCase {
    ...
    private static List<Field> getMockFields(Class<?> type) {
        ...
        if (type == TestCase.class || type == BaseMockTests.class || type == Object.class) {
