...
import static com.googlecode.lazyparsec.Parsers.always;
import static com.googlecode.lazyparsec.TestParsers.areChars;
import static com.googlecode.lazyparsec.TestParsers.isChar;
 ...
 * @author Ben Yu
 */
public class ParsersTest extends BaseMockTests {
  ...
  @Mock
  Callable2<Character, Character, Integer> callable2;
  public void testSequence_withMap2() throws Exception {
    expect(callable2.call('a', 'b')).andReturn(1);
    replay();
    Parser<Integer> parser = Parsers.sequence(isChar('a'), isChar('b'), callable2);
    assertEquals(callable2.toString(), parser.toString());
  ...
  @Mock
  Callable4<Character, Character, Character, Character, Integer> callable4;
  public void testSequence_withMap4() throws Exception {
    expect(callable4.call('a', 'b', 'c', 'd')).andReturn(1);
    replay();
    Parser<Integer> parser =
        Parsers.sequence(isChar('a'), isChar('b'), isChar('c'), isChar('d'), callable4);
    assertEquals(callable4.toString(), parser.toString());
