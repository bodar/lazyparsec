...
final class Keywords {
  ...
  private interface StringCase {
    ...
    <T> com.googlecode.lazyparsec.functors.Map<String, T> toMap(java.util.Map<String, T> m);
  }
  ...
  private static class CaseSensitive implements StringCase {
    ...
    public <T> com.googlecode.lazyparsec.functors.Map<String, T> toMap(java.util.Map<String, T> m) {
      return Maps.map(m);
    }
  }
  ...
  private static class CaseInsensitive implements StringCase {
    ...
    public <T> com.googlecode.lazyparsec.functors.Map<String, T> toMap(
        final java.util.Map<String, T> m) {
      return new com.googlecode.lazyparsec.functors.Map<String,T>() {
